...
async function main() {
  ...
  const urls = [
    ...
    { loc: `${SITE}/materialcalculator/`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${SITE}/materialcalculator/paint/`, priority: '0.8', changefreq: 'monthly' },
    { loc: `${SITE}/materialcalculator/aac-blocks/`, priority: '0.8', changefreq: 'monthly' },
