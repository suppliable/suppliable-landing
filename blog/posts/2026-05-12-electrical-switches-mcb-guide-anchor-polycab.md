---
title: Best Electrical Switches and MCBs for Indian Homes (Anchor vs Polycab vs Legrand)
date: 2026-05-12
author: Suppliable team
description: A buyer's guide to choosing modular switches, MCBs and distribution boards for an Indian home — what each costs, which brand fits which budget, and how to size your DB.
tags: [electrical, switches, mcb, anchor, polycab, construction-guide]
---
...
[Browse modular switches →](/products/electrical/)
...
[Browse MCBs →](/products/electrical/)
...
[Browse house wires →](/products/electrical/)
...
**Brands**: Anchor Ellgee, Schneider Easy9, Havells Distri are all reliable. We stock [Ellgee 8-way DB boxes →](/products/electrical/) for the most common 2BHK/3BHK use case.
...
**Brands**: Orbit, Mount Plast both have full ranges of conduits, bends, junction boxes. Avoid generic unbranded — they crack during chase-cutting. [Browse electrical conduits →](/products/electrical-conduits/)
...
1. **Buying cheap, unbranded wire**. The single biggest electrical fire risk.
2. **Skipping the RCCB**. Mandatory by code and saves lives. ~₹1,200 for the unit.
3. **Mixing single-phase and three-phase loads on wrong circuits**. Have your electrician sign off the loading.
4. **Concealing wires without conduits**. Code violation, no future serviceability.
5. **Buying decorative switch plates without matching the brand's plate base**. The plates don't fit cross-brand.
...
[Browse all electrical products →](/products/electrical/) — all in stock at Suppliable Sholinganallur, delivered to your Chennai site in 60 minutes.
